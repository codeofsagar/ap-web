  ...
  return (
    ...
    >
      <Link
        ...
        className="flex flex-col gap-4 lg:gap-5 px-3 lg:px-4 pt-3 lg:pt-4 pb-5 lg:pb-6  bg-[#473c2a] cursor-pointer group relative"
      ...
      >
        <div className="relative  overflow-hidden w-full h-[260px] md:h-[350px] lg:h-[clamp(500px,32vw,800px)]">
